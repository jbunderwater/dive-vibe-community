...
- **Getting There**: Major airports in Antalya, Dalaman, and Bodrum serve the dive regions. Direct flights from Europe available year-round.
- **Dive Operators**: Both Kaş and Bodrum have established PADI-certified dive centers with professional staff and modern equipment.
- **Accommodation**: Options range from budget guesthouses to resort-style hotels, many directly accessible from dive shops.
- **Transportation**: Local minibus services connect towns; dive operators provide boat access to offshore sites.
- **Facilities**: Professional dive centers offer full rental equipment, guide services, certification courses, and nitrox availability.
...
### Best Time to Visit
- **Peak Season**: June-September (warmest water, most stable conditions, busiest)
- **Shoulder Season**: May, October (still good diving, fewer crowds, good visibility)
- **Off-Season**: November-April (variable conditions, colder water, occasional calm days with excellent diving)

### Water Temperature & Wetsuits
- **Summer (Jul-Aug)**: 26-28°C water, 3-5mm wetsuits
- **Spring/Fall (May-Jun, Sep-Oct)**: 20-25°C water, 7mm wetsuits
- **Winter (Nov-Apr)**: 16-20°C water, 10mm wetsuits or thicker

### Dive Costs
- Guided boat dives: €60-90 per dive
- Equipment rental: €10-20 per item
- Certification courses: €300-400 for Open Water
- Accommodation: €30-150 per night depending on comfort level

### Essential Information
- **Currency**: Turkish Lira (TRY)
- **Language**: Turkish (English widely spoken at dive centers)
- **Hyperbaric Facility**: Verify location before diving (Bodrum has Chamber of Commerce facility)
- **Dive Insurance**: Recommended; some operators offer basic coverage
- **Permits**: Generally not required for recreational diving at marked sites
...
- **Decompression**: Mandatory safety stops required at deeper sites. Plan bottom time.
