...
- **Best Time**: May–October (spring and autumn for barracuda schools)
...
Locate the two prominent steam boilers, which are the defining navigational features of the wreck. Explore the paddlewheel frame lying on its side, then swim through the accessible interior section of the Montana's hull remains. Cross to the adjacent Constellation wreck on the same dive to cover both historical sites. The 9-meter depth provides unlimited bottom time within recreational limits.
...
At 9 meters, depth hazards are minimal. The primary concerns are the offshore location — approximately 4 miles from the island — meaning weather changes can make the return boat trip uncomfortable. Assess morning conditions carefully. Always stay with the group at this relatively exposed site.
