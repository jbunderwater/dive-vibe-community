...
The resident pod of stingrays at Current Cut is one of the site's defining features (confirmed by zentacle.com). Large fish that would flee in calm conditions hold position in crevices and feed on prey swept through by the current. Caribbean reef sharks and blacktip sharks, eagle rays, yellowtail snapper, green moray eels, lobster, and barracuda are documented using the rock formations as shelter from the flow (diveoneclub.com, discover-eleuthera-bahamas.com). No source reviewed today specifically confirms grouper at this site, so that claim has been removed rather than carried forward as a generic assumption. One source (discover-eleuthera-bahamas.com) also mentions "mako sharks," which is not corroborated elsewhere and is atypical habitat for that species — noted here as an outlier claim rather than repeated as fact.
...
---
**Note on duplicate entry:** This site (25.4035704, -76.7922449) and the separate "Current Cut Eleuthera" entry (25.4167, -76.7833, `divesites/bahamas/current-cut-eleuthera.md`) are approximately 1.7 km apart, but every source consulted in today's re-audit — eleuthera.me, zentacle.com, dive-the-world.com, discover-eleuthera-bahamas.com, and diveoneclub.com — describes a single ~1 km-long, ~100-yard-wide tidal channel between North Eleuthera and Current Island, with the same current pattern (6-10 knots), same depth range (~16-18m), and same core marine life. No source documents two separately-named or geographically distinct dive sites here. This strongly suggests a near-duplicate entry (two coordinate captures of the same real-world channel) rather than genuinely distinct sites. Recommend review for merge/dedup.

*Sources: [Eleuthera.me - Current Cut](https://eleuthera.me/currentcut.html), [Zentacle - Current Cut](https://www.zentacle.com/Beach/3565/current-cut), [Dive the World - Eleuthera](https://www.dive-the-world.com/diving-sites-bahamas-eleuthera.php), [Discover Eleuthera Bahamas - The Current Cut](https://www.discover-eleuthera-bahamas.com/the-current-cut/), [DiveOne Club - Current Cut Eleuthera](https://diveoneclub.com/en/dive-sites/current-cut-eleuthera). Last updated 2026-07-17.*
