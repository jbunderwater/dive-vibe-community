...
- **Maximum Depth**: 18 meters (sources vary — one reports a shallower ~10m maximum, others describe depths approaching 18-19m as the channel deepens)
- **Current**: 6-10 knots at peak tidal flow (multiple sources agree on this range)
- **Typical Visibility**: 15-25 meters (incoming tide preferred for clearest water)
- **Best Time**: November to May

## Marine Life

A resident pod of stingrays is one of the site's defining features, confirmed across multiple sources. Blacktip sharks are the shark species most consistently reported in the cut — divers are sometimes dropped along a section nicknamed "Shark Alley" where blacktips feed on schools of fish swept through by the current. Eagle rays, lobster, parrotfish, and queen angelfish are also reported holding position in crevices and potholes to feed on prey carried by the flow. (One source additionally mentions mako sharks, but this is not corroborated elsewhere and mako sharks — an open-ocean pelagic species — would be an unusual sighting in a shallow inshore channel, so it is not treated as confirmed here.)
...
---
*Sources: [Eleuthera.me - Current Cut](https://eleuthera.me/currentcut.html), [Zentacle - Current Cut](https://www.zentacle.com/Beach/3565/current-cut), [Discover Eleuthera Bahamas - The Current Cut](https://www.discover-eleuthera-bahamas.com/the-current-cut/). Last updated 2026-07-14.*
