...
---
*Sources: [ScubaWeather - Connected Dott](https://www.scubaweather.com/Bahamas/Great_Exuma_Island/Connected%20Dott/Point_DiveSiteMap.html). Re-audited 2026-07-13: searched Dive Exuma, ScubaBoard, TripAdvisor, and dive-site aggregators (ScubaSnap, Divebooker) for a second independent source. ScubaSnap's Bahamas listing surfaces the name "Connected dott" but its site page has no original descriptive content beyond a generic auto-populated template, so it was not counted as an independent confirming source. No second or third source was found. The unusual name may be a typo or OSM mangling (possibly of "Connect the Dots" or similar); no dive shop or forum reference to that alternate spelling was found either. Validation status remains false. Last updated 2026-07-13.*
