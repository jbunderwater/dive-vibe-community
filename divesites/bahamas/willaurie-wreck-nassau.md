...
Sources disagree on the Willaurie's origins. DreamWrecks and Scuba Diver Life describe her as a 130-foot (39.6 m) steel freighter built in the Netherlands in 1966, which served the Bahamas from 1980 as an inter-island mailboat — transporting mail and freight between Nassau and the outer islands of Rum Cay, San Salvador, and Cat Island. Two other independent sources — Wannadive and Ash Underwater — instead describe her as built in Denmark in 1907, with Ash Underwater additionally giving her length as 140 feet and calling her a barge rather than a mailboat. This audit could not resolve the conflict; both pairs of sources are established dive-site references, so both versions are recorded here rather than one being silently chosen.

Bahamian maritime historian Eric Wiberg (writing in The Tribune) states that the Willaurie sank three separate times over her working life. On the final occasion, she was under tow from Nassau, heading out to be deliberately scuttled, when the towline parted and she grounded off Clifton Pier — so the vessel's demise was not a simple binary of "accidental" versus "deliberate": the tow itself was undertaken with the intent of scuttling her, but the sinking that actually occurred happened prematurely, before she reached her intended site, when the tow parted in heavy seas. On Christmas Day 1988, Stuart Cove's Dive Bahamas patched the hull at low tide, partially refloated the wreck, and moved it to its current resting position on the southwest side of New Providence, where it settled for good. The Willaurie now sits on the sandy bottom; sources give depths in the range of roughly 15–21 metres. Its most distinctive feature is the open cargo hold — the metal support bars of the original hold now form an underwater scaffold-like structure that soft corals have colonised; divers are advised not to swim inside the scaffolding, since exhaled bubbles can dislodge the coral growth. The site has been a popular Nassau wreck for over three decades. Visibility is 20–30 metres. Water temperature 25–28°C.
