...
- **Location**: Little Salvages, off Rockport, Massachusetts
...
Boat charter required from Cape Ann area operators. The Little Salvages area is navigational hazard territory — a local captain is essential. The USS Grouse and California wreck are close enough to combine on a single charter trip. Deploy SMB clearly before ascending from depth.
...
Rocky shoal area with significant navigation hazards for boats. Cold water year-round — 7mm wetsuit or drysuit required. Tidal current can be significant — plan dives around slack. Deploy SMB clearly before surfacing. A competent local captain who knows the Salvages is mandatory.

## Photography

The scattered metal debris provides close-focus subjects with strobe lighting — encrusting anemones, bryozoans, and sea urchins on fittings create compelling macro images. Seal encounters offer wide-angle opportunities if the animals approach from the nearby colony.
