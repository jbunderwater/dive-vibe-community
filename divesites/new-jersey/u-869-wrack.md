...
The cause of U-869's sinking remains debated. The official German naval record listed her as sunk off Gibraltar on February 28, 1945, by USS *Fowler* and the French submarine chaser *L'Indiscret* — a record that post-war analysis has conclusively shown to be wrong. The U.S. Coast Guard evaluation and researcher Gary Gentile both credit USS *Howard D. Crow* and USS *Koiner*, which attacked a contact in the area on February 11, 1945, using hedgehog and depth charges. Chatterton and Kohler proposed an alternative: that U-869 was sunk by her own malfunctioning torpedo on a circular run, also on February 11, 1945. The Coast Guard's evaluation specifically rejected the circle-runner theory, citing two separate damage holes in the wreck consistent with two depth-charge detonations rather than a single torpedo impact. The circle-runner theory is not the official conclusion — it is compellingly argued in Robert Kurson's *Shadow Divers* and Chatterton's own final report, but the destroyer-escort attack remains the better-supported explanation.
