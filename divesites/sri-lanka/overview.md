...
Historic shipwrecks, coral reefs, and seasonal whale shark encounters.

## Description

Sri Lanka is a notable diving destination in the Asia region, offering 3 documented dive sites with depths ranging from 5 to 25 meters. Water temperatures average 26-30°C (79-86°F), with visibility typically reaching 10-40 meters (30-130 feet). Year-round diving is possible, with the best conditions during October to April (varies by location).
...
- **Getting There**: Sri Lanka is accessible via international and regional flights to nearby airports. Check with airlines for current routes and connections.
