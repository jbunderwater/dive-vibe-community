...
The diving here is unusual in two respects. First, a prominent pinnacle (described as a "haystack rock" by both MDA and PADI) rises from a sandy bottom at approximately 27 meters (90 feet) to within 4–5 meters (12–15 feet) of the surface, covered in fish and coral — PADI's dive site database independently confirms this same 90ft-to-15ft profile. Sea fans are present at approximately 12 meters (40 feet) — shallower than is typical for gorgonian fans at most Guam sites; both MDA and PADI confirm this depth. Second, the seafloor around the site is littered with WWII military debris. War History Online documented at the site: at least ten LVT Buffalos (amphibious tracked vehicles), the remains of a locomotive, a bulldozer, a large flatbed trailer, a couple of silver tea trays concreted to surrounding metalwork, and other equipment. Japanese tanks have been reported at approximately 60 meters — the War History Online author notes this secondhand, stating they personally lacked the trimix gear needed to verify it, so this remains an unconfirmed report rather than an established fact. This material is believed to be equipment discarded after the 1944 liberation of Guam.

**Note on PADI's generic wildlife list**: PADI's database lists "sharks, whales, dolphins, turtles" for Shark Pit — the same four-species checklist that recurs on unrelated PADI Guam site pages (e.g. Gab Gab Reef), indicating a templated regional default rather than site-specific reporting. It is not used as a marine-life source here.
...
---
*Sources: [MDA Guam — Sharks Pit](https://www.mdaguam.com/destination/sharks-pit/), [War History Online — War Wreck Diving in Guam](https://www.warhistoryonline.com/war-articles/war-wreck-diving-in-guam.html), [PADI — Sharks Pit dive site](https://www.padi.com/dive-site/guam/sharks-pit/). Note: the previously cited SSI/divessi.com dive-site page (309332) no longer resolves to site content — the SSI dive guide has migrated to scubago.com and the specific listing could not be re-verified during this QA pass, so it has been replaced with PADI as the third source. Last updated 2026-08-05.*
