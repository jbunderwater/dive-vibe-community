...
**Date of sinking: Sources conflict, but the weight of evidence favors 1976.** The UCR primary first-person account states the collision occurred in June 1976, with Hurricane Liza (September 30, 1976) subsequently rolling the hull and stripping the deck superstructure. Baja Diving independently states the vessel "sank in 1976." PADI's database is the lone source giving a different date: June 19, 1975. Three independent sources (UCR, Baja Diving, and the internal Hurricane Liza timeline) support 1976 against one source (PADI) for 1975; both dates are documented here rather than silently picking one.
