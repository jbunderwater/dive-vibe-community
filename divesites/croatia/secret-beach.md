...
Enter via the small cave to the hidden beach. The shallow area is ideal for training and warm-up. The columns with crustaceans are the main feature of the intermediate depth zone. The steep wall transition at 30m provides a deeper option for experienced divers. Safety stop at 5 metres.

## Entry and Exit

Shore entry via a small cave passage. The site is steps from the dive centre — no shuttle bus required. The sheltered position provides calm conditions for all entries and exits.

## Tips and Recommendations

- A night dive here produces reliable octopus sightings — well worth scheduling
- The column zone with crabs and shrimp is the photographic highlight for macro work
- The hidden beach entry is an atmospheric start to the dive — take a moment to appreciate the setting
- This site suits all levels: training in the shallows, columns in the mid-range, wall for advanced divers

## Safety Considerations

The sheltered hidden beach position makes this one of the most benign entry points in the Kvarner. Standard beginner parameters apply in the shallow zone; the 30-metre wall extension requires intermediate skills. Carry an SMB and dive with a buddy.
