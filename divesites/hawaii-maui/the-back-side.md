...
- **Location**: Molokini Crater, Maui, Hawaii (outer south-facing wall)
...
- Advanced Open Water certification is the minimum; most operators require evidence of recent boat diving and drift experience. Some will ask to see your logbook.
- The back wall can only be safely dived in calm conditions — morning departures before the trade winds strengthen are standard. Operators will not proceed if swells are running.
- Surface marker buoys are mandatory equipment; boat pick-up is entirely dependent on your SMB being visible.
