...
The aircraft measures approximately 12 metres wingspan and 9 metres in length, with a 1,200 hp Pratt & Whitney engine — now absent from the wreck ("le moteur a disparu"; only twisted cables and metal sheeting remain, per miopalmoplongee.com). Sources disagree on armament: the official Port-Cros National Park dive-trail page (destination.portcros-parcnational.fr) documents four 12.7mm machine guns, two visible in each wing, while aqualonde-plongee.com states six ("six mitrailleuses"). A previous version of this description asserted "6 total, confirmed by all sources" — that was incorrect; a 2026-08-23 re-audit found miopalmoplongee.com, the source that claim was attributed to, does not state a gun count at all. Both figures are plausible: real F4F Wildcat/Martlet variants were built with either four or six .50-calibre guns depending on model. The Royal Navy operated more than 1,200 F4F Wildcats under the Martlet designation during World War II.
...
---
*Sources: [en.bormesplongee.fr — Wildcat](https://en.bormesplongee.fr/wildcat), [Tribloo — Wildcat F4F](https://www.tribloo.com/fr/spot-plongee/124/le-wildcat-f4f.html), [Mio Palmo Plongée — Le Wildcat](https://www.miopalmoplongee.com/nos-sites/le-wildcat.php), [Destination Port-Cros — Épave du Wildcat](https://destination.portcros-parcnational.fr/outdoor-site/3-Plongee-sur-l-epave-du-Wildcat), [Aqualonde Plongée — Le Wildcat](https://aqualonde-plongee.com/sites-de-plongee/epaves/wildcat/). Last updated 2026-08-23.*
