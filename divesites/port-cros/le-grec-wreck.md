...
Note on dates: A dedicated French Wikipedia article on this wreck (fr.wikipedia.org/wiki/Sagona_(épave), distinct from the English-language SS Sagona article) independently corroborates 3 December 1945 and every other core fact — build year, builder, dimensions, tonnage, casualties, and depth — matching all dive-specific sources exactly. The English Wikipedia SS Sagona article, which focuses on the ship's earlier career as a Newfoundland–Labrador sealing and ferry vessel, instead gives 21 November 1945 and a Nice-to-Toulon route for its loss; that article's shipbuilding details (1912, Dundee Shipbuilding Co., 808 GRT) match this vessel exactly, so it is almost certainly the same ship, but its stated loss date and route conflict with the dedicated French wreck article and all four dive-specific sources consulted (en.bormesplongee.fr, provencemed.com, tribloo.com, aqualonde-plongee.com), which agree on 3 December 1945.
