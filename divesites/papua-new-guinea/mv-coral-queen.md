...
---
*Sources: [Michael McFadyen's Scuba Diving Web Site](https://www.michaelmcfadyenscuba.info/viewpage.php?page_id=484), [underwaterasia.info](https://www.underwaterasia.info/), [ScubaBoard – PNG flashlight fish](https://www.scubaboard.com/). Re-audited 2026-08-18: added the vessel's pre-Madang history (1958 build, British Solomon Islands service, Buka/Bougainville sinking, salvage) -- this is sourced from McFadyen alone and has not been independently corroborated by a second detailed source, so treat it as provisional. Depth profile (32m/28m/23m) and the flashlight-fish colony are corroborated across sources. Last updated 2026-08-18.*
