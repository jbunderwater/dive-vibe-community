...
Located at the northern end of the Soufriere Scotts Head Marine Reserve, Champagne Reef is accessible from a black lava beach via a boardwalk, with easy shore entry and typically calm conditions and very little current. The geothermal vents are concentrated in the shallow sandy area near the beach, where the sand itself is noticeably warm to the touch. Beyond the vent field, the fringing reef gradually slopes down toward greater depth via walls and boulders; sources describe this deeper extension but do not agree on an exact maximum depth, so no specific figure is given here beyond the site's rated 12-metre depth. This section is studded with barrel sponges and encrusting corals. The dive is typically done as a circuit: explore the reef first, then finish with a leisurely safety stop through the bubble fields.
