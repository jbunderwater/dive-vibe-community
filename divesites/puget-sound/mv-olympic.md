...
MV Olympic is a historic wreck dive in Puget Sound, North America.
...
---
*Sources: [Salish Sea Then and Now — Shipwrecks on Puget Sound](https://salishseathenandnow.substack.com/p/looking-at-a-few-shipwrecks-on-puget), [Wikipedia — MV Olympic (ferry)](https://en.wikipedia.org/wiki/MV_Olympic_(ferry)), [InvestigateWest — Washington's old ferries](https://www.investigatewest.org/washington-ferries-are-going-hybrid-electric-but-disposal-of-old-ones-poses-environmental-legal-risks/). Note: Wreck rests on private Ketron Island property (access=private); submerged dive access is unconfirmed by dive-specific sources. Re-audited 2026-08-27: grounding date (May 2010), Ketron Island location, and private-property access status re-confirmed via Wikipedia and a second Salish Sea Then and Now article on Puget Sound shipwrecks; no changes needed. Last updated 2026-08-27.*
