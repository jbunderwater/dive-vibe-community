...
The Oduna was built in 1945 at South Portland, Maine, as a Liberty-type (EC-S-C1) cargo ship for the US Maritime Commission. The vessel measured 422.8 feet in length and 57 feet in breadth, with a gross tonnage of 7,252 tons (net tonnage 4,452). Originally launched as the ***Francis*** *A. Retka* (corrected from an earlier "Francia" spelling error on this page — confirmed independently by both alaskashipwreck.com and the usmm.org Liberty ship registry), the vessel was renamed *Liberty Bell*, then *I. R. Lashins*, then *Southport*, before finally being acquired by the Alaska Steamship Company and renamed Oduna, which modified it to carry refrigerated shipping containers.
...
---
*Sources: [Alaska Shipwrecks — O](https://alaskashipwreck.com/shipwrecks-a-z/alaska-shipwrecks-o/), [CoastView — Cape Pankof, Ikatan Peninsula](https://coastview.org/2023/05/04/cape-pankof-unimak-island/), [ScubaBoard — Wreck diver dragged down and pinned, False Pass, Alaska](https://scubaboard.com/community/threads/wreck-diver-dragged-down-and-pinned-false-pass-alaska.567663/), [USMM.org — Liberty Ship Registry (New England-built)](https://www.usmm.org/l/neweng.html), [U.S. Maritime Administration — Gallant Ship Award, Tug Adeline Foss](https://www.maritime.dot.gov/history/gallant-ship-award/tug-adeline-foss). Re-audited 2026-07-09: corrected the vessel's original name from "Francia A. Retka" to "Francis A. Retka" and confirmed the tug Adeline Foss identity/history. Last updated 2026-07-09.*
