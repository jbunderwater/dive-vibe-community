...
A charted rock in the Langara Island area of Haida Gwaii with no independent documentation found.

## Overview

Gatenby Rock's coordinates fall within the same Langara Island cluster as several other named rocks in this dataset. Extensive searches (fishing-hotspot lists, place-name histories, nautical chart references, dive sources) returned no documentation of this feature under any context — diving, fishing, or otherwise.
...
- **Location**: Near Langara Island, Haida Gwaii, British Columbia (Dixon Entrance approaches)
