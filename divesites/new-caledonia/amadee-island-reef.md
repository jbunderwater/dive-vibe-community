...
Sea turtles are frequently encountered on the reef, and green sea turtles favor the seagrass beds near the jetty in particular (Snorkeling Report). Banded sea snakes are abundant around the island and, while venomous, are consistently described as docile and non-aggressive. Bicolor angelfish, keyhole angelfish, and two-thorn angelfish frequent the coral, and sea anemones with resident clownfish are common (Snorkeling Report). Whitetip reef sharks are occasionally seen on the deeper outer reef. The Marine Protected Area status has allowed fish populations to flourish. The broader New Caledonia lagoon (a UNESCO World Heritage site) is noted for high coral diversity, but no independently verified species count for this specific reef site was found; a prior QA pass's generic "butterflyfish, parrotfish, wrasses" claim has been replaced with these site-specific species.
...
---
*Sources: [Michael McFadyen's Scuba Diving Web Site](https://www.michaelmcfadyenscuba.info), [New Caledonia Tourism — Amedee Lighthouse](https://au.newcaledonia.travel/destination/noumea/amedee-lighthouse/), [Snorkeling Report — Ilot Amedee](https://www.snorkeling-report.com/spot/snorkeling-ilot-amedee-new-caledonia/). Note: Species count claims ("200+ fish species, 80 coral species") remain removed — not confirmed by any authoritative source. Re-audited 2026-08-14: Marine Life section rewritten with site-specific species (angelfish varieties, whitetip reef sharks) from Snorkeling Report, replacing an unconfirmed generic species list from the prior QA pass. Last updated 2026-08-14.*
