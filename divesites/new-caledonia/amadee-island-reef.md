...
Sea turtles are frequently encountered on the reef, especially in seagrass meadows near the jetty and the island's western end, where they are reported approaching within about 10 meters of shore. Sea snakes (locally "tricot raye") are regularly encountered around the island -- described as a large population by one independent source and as occasional/shy at the water's edge by New Caledonia Tourism; both agree they are venomous but docile and non-aggressive if undisturbed. Clownfish, butterflyfish, and wrasses are confirmed here, along with triggerfish, angelfish, groupers, trevally, porcupinefish, and razorfish. Whitetip reef sharks are occasionally seen on the deeper outer reef, and dugongs are an exceptional but documented sighting. The Marine Protected Area status has allowed fish populations to flourish. The broader New Caledonia lagoon (a UNESCO World Heritage site) is noted for high coral diversity, but no independently verified species count for this specific reef site was found. Note: an earlier draft of this description included parrotfish, which no source confirms for this specific site -- it has been removed.
...
---
*Sources: [New Caledonia Tourism — Amedee Lighthouse](https://www.newcaledonia.travel/destination/noumea/amedee-lighthouse/), [Snorkeling Report — Ilot Amedee](https://www.snorkeling-report.com/spot/snorkeling-ilot-amedee-new-caledonia/), [Freestyle Traveling — What to Do in Amedee Island](https://freestyletraveling.com/what-to-do-in-amedee-island/). Re-audited 2026-08-15: replaced the homepage-only McFadyen citation (no dedicated Amadee page could be located on his site) with Freestyle Traveling, which independently confirms the sea snake population and turtle sightings for this specific island. Removed "parrotfish" from marine life -- unconfirmed by any source found. A solopassport.com trip report mentioning manta rays and a grey nurse shark on an "Amedee" dive was found but excluded, since those species read as a Boulari Pass encounter on the same boat trip rather than sightings on this shallow reef. Species count claims ("200+ fish species, 80 coral species") remain removed from the prior QA pass — still not confirmed by any authoritative source. Last updated 2026-08-15.*
