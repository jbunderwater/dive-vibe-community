...
Enter from the sandy beach and surface swim to the reef shoulder. The sandy plateau leads to a manageable reef entry at 13 metres. The wall then descends steeply to a sandy plain at 25 metres. This sequence — shallow plateau, clear wall structure, sandy bottom — suits beginners learning depth transitions. The site can also be dived shallower for snorkelling practice or navigation skills.

## Entry and Exit

Sandy beach entry with good footing. Some coral rubble may be present near the waterline — reef shoes recommended. Wade out to floating depth, then fin across the plateau. Exit via the same beach. The beach offers shade palapas, restrooms, and a relaxed surface interval environment.
