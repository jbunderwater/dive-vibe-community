...
- **Current**: Moderate; variable with tidal conditions
...
Descend the mooring line to the highest point of the wreck and orient yourself to the hull before exploring. Work from one end to the other, examining deck structures, any open interior sections, the engine room area, and the stern or bow features. Most of the interesting coral growth concentrates on the upper sections exposed to natural light. If penetrating, stay shallow within the structure and maintain a clear visual reference to daylight. Ascend with 50 bar reserve and complete a 5-minute safety stop at 5 meters.

## Entry and Exit

Accessible by day boat from Marsa Alam-area dive centres and on liveaboard itineraries covering the southern Red Sea coast. Entry via giant stride from the dive deck. Mooring or descent line is typically rigged to the wreck. Deploy SMB before ascending for boat pickup.
