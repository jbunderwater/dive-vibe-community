...
---
*Re-audit note (2026-09-11): Bluewater Dive Travel's Solomon Islands page lists a Russell Islands feature it calls "Mirror Pond" alongside "Custom Cave" and Leru Cut, consistent with this site's general description, but gives no further site-specific detail beyond the name. The specific marine-life list below (cardinalfish, basslets, sponges, tunicates, shrimps) was not independently re-confirmed against a site-specific source during this re-audit and should be treated as plausible rather than verified. The uepi.com source was not re-verified as reachable during this pass; not removed, but flagged for a future check.*
*Sources: [Uepi Island Resort - Diving](https://www.uepi.com/diving), [Bluewater Dive Travel - Solomon Islands](https://www.bluewaterdivetravel.com/destination/solomon-islands-diving), [Dive the World - Solomon Islands](https://www.dive-the-world.com/diving-sites-solomon-islands.php). Last updated 2026-09-11.*
