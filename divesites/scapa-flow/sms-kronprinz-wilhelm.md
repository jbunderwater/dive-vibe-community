...
The most accessible of Scapa Flow's three König-class battleships — lying inverted at 38 metres with the port side uppermost and the shallowest point at 12 metres, the recommended starting point for understanding the Fleet's great battleships.
...
- **Current orientation**: Inverted, port side uppermost; 12 m at shallowest, 38 m maximum depth
...
Descend to the upturned hull at 12 metres and navigate along the keel, descending gradually toward the deeper sections at 36–38 metres. Half of the 12-inch gun complement remains visible and accessible. The inverted hull at 12 metres allows extended shallow exploration before committing to depth. The sheer scale of the 175-metre battleship hull rising from the seabed is the primary visual impact. Plan descent and ascent carefully — the Advanced depth profile and cold water require conservative gas planning.

## Entry and Exit

Boat dive from Stromness charter operators. Advanced Open Water certification minimum — some operators require wreck diving experience beyond this. Shot line descent. Dry suit and cold-water regulators mandatory. SMB deployment before surfacing. A diving permit from Orkney Islands Council Harbours Department is required.

## Tips and Recommendations

- Dive the Kronprinz Wilhelm before attempting the König or Markgraf — it is the recommended introduction to the battleships
- The hull rising to 12 metres provides extended shallow exploration before committing to deeper sections
- Study König-class battleship plans before diving — the inverted orientation requires structural understanding to navigate effectively
- Multiple dives across multiple days are needed to comprehend the full scale of a 175-metre battleship hull
- The 12-metre shallowest point allows a long decompression-free dive on the upper hull with excellent light in summer

## Safety Considerations

This is a protected scheduled monument under the Protection of Wrecks Act 1973. The 38-metre depth with cold water and elevated gas consumption requires careful dive planning. No-decompression limits must be managed with a safe gas reserve for ascent. No artefact contact or removal is permitted. A diving permit from Orkney Islands Council Harbours Department is required.
