...
---
*Sources: [DiveMasterAustin - Santa Cruz Coiba](https://divemasteraustin.com/dive-sites/santa-cruz-coiba). Last updated 2026-07-26. (2026-07-26 re-audit: Panama Dive Center and Coiba Island were removed from the source list — on re-fetching both sites' complete dive site listings in full, neither mentions "Santa Cruz." An extensive follow-up search found no second independent source describing this site; every result traces back to the single DiveMasterAustin article above. All content on this page has been reconfirmed against that source and is accurate to it, but this entry currently falls short of the 3-independent-source bar and should be treated as single-sourced until a second operator or forum report can be found.)*
