...
Access is by dive boat from Tortola or Virgin Gorda operators. The site has a mooring buoy. Entry via giant stride or back roll. Currents here can run strong, so follow the dive leader closely on both entry and exit. Deploy an SMB for safety stop and boat pickup.
...
Currents at Wall to Wall can run strong and require close attention to the dive leader — this is the primary reason for the site's Advanced rating, not the depth alone. Monitor depth carefully in the canyon section — the wall continues to 20+ meters. Fire coral may be present on some formations. Carry an SMB. Dive with a buddy.
...
---
*Sources: [BVI Dive Map](https://bvi-dive-map.com/site/wall-to-wall/), [BVI Diving – Wall to Wall](https://www.bvidiving.com/diving-wall-to-wall-bvi.html), [Sail Caribbean Divers](https://www.sailcaribbeandivers.com/more-info/dive-sites/). Last updated 2026-07-22.*

*QA note (2026-07-22): difficulty corrected from Beginner to Advanced. BVI Dive Map and BVI Diving both independently describe this site as regularly subject to strong current, and BVI Diving/Sail Caribbean list depths reaching into the low 20-meter range — the previous Beginner rating was not supported by either primary source.*
