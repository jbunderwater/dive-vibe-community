...
- **Current**: Low to moderate depending on site
- **Swell**: High on exposed aspects
- **Best Time**: Year-round; calmer in dry season (December–April)
...
Access by boat only — the remote location requires a dedicated day charter or liveaboard. The no-anchor policy means all boats must use moorings where available. Deploy SMB for ascent and pickup. Entry and exit via giant stride or back roll depending on conditions.

## Tips and Recommendations

- Engage a local BVI operator familiar with this area; Jost Van Dyke Scuba offers trips here
- The Mercurious Rock cave requires proper cavern/cave training and underwater lighting
- Multiple sites around the island allow operators to select the most sheltered aspect given the day's conditions
- Surface intervals on the boat are recommended as shore access is not permitted

## Safety Considerations

The remote location means limited emergency response — conservative dive planning is essential. The Mercurious Rock cave system requires appropriate overhead environment training; it should not be entered by open-water divers. Swell can be significant on exposed sides of the island. Always dive with a buddy. Carry a surface marker buoy (SMB).
