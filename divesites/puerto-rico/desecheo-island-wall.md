...
Desecheo's remoteness and protected status deliver encounter rates that are exceptional by Puerto Rican standards. Nurse sharks are specifically documented at the site by Aquatica PR; PADI's own site listing mentions sharks more generally without naming a species, so treat "Caribbean reef shark" as unconfirmed rather than guaranteed. Spotted eagle rays and dolphins are reported as regular visitors by Aquatica PR, with whales occasionally seen in winter. Large groupers, snappers, and parrotfish are confirmed as abundant. Schools of fish fill the water column at the reef and cave sections. Hawksbill turtles are documented. The diverse site types — coral gardens at Candyland, wall and overhangs at Yellow Reef (also referred to as Ladder Reef by some operators), and caves/tunnels at Las Cuevas — each produce different marine encounters. Note: manta ray and hammerhead shark sightings are claimed by some sources for Desecheo but have not been confirmed by multiple independent operator reports; treat these as possible but unverified.
