...
Walk entry from the beach through the seagrass to the reef. Navigate along the reef at 3–8 metres, working east or west depending on preference. The reef extends for several hundred metres and can be explored extensively in a single dive. Return to the beach entry point by compass or shoreline navigation. No safety stop required at this depth.
