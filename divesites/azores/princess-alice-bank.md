...
One of the world's best seamount dives — massive aggregations of mobula rays, giant mantas, and Galapagos sharks 45–50 nautical miles from land.
...
- July to September for the mobula ray aggregations — they form coordinated carousels and frequently approach divers at close range
- Most operators require 50+ logged dives, Advanced Open Water certification, and a check dive before the trip
- 2.5–3 hour crossing from Pico or Faial — carry seasickness medication; the journey is weather-dependent
- Currents can be several knots; buoyancy control and awareness of bottom time are essential
- Trip cancellations are common — build flexibility into your schedule

---
*Sources: [dive.visitazores.com](https://dive.visitazores.com/en/divespots/princesa-alice), [CW Azores](https://www.cwazores.com/princess-alice), [Wikipedia – Princess Alice Bank](https://en.wikipedia.org/wiki/Princess_Alice_Bank), [DeeperBlue](https://www.deeperblue.com/exploring-azores-princess-alice-bank/). Re-audited 2026-07-12: depth, certification requirements, and marine life claims re-confirmed against current source content; no changes required. Last updated 2026-07-12.*
