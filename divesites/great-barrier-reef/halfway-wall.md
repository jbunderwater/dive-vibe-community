...
Liveaboard only. Descent direct from the surface to the wall top. Exit via SMB from open water with liveaboard tender pickup.

## Tips and Recommendations

- Maintain your position on the wall rather than drifting into the blue — the best life is on the wall itself
- Use a focus light on the soft coral branches to illuminate the smaller animals living among them
- The wall is long enough to drift slowly with even a very gentle current — let the site come to you

## Safety Considerations

Wall dives require consistent depth monitoring — it is easy to drift deeper than intended while focusing on wall subjects. Set a maximum depth alarm if your dive computer supports it. Osprey Reef's remote location means conservative profiles are standard practice.
