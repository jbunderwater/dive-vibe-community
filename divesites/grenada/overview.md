...
- **Getting There**: Maurice Bishop International Airport (GND) receives flights from Miami, New York (JFK), Toronto, and London, plus inter-island connections from Barbados, Trinidad, and St. Vincent. Grenada is also a popular cruise ship port.
- **Dive Operators**: Dive Grenada (over 100 years of combined staff experience, TripAdvisor Certificate of Excellence for nine consecutive years) and ECO Dive Grenada are the primary PADI-certified operations.
- **Accommodation**: Grand Anse Beach area offers the widest range from budget guesthouses to luxury resorts. Dive packages are available through most operators.
- **Transportation**: Taxis and rental cars available. The island is compact — most dive sites are accessible from the southwest coast.
- **Facilities**: Well-equipped dive operations with GPS-equipped boats, emergency oxygen, and VHF radio.
