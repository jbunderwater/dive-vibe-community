...
## Marine Life
Spiny lobsters are the namesake inhabitants, found in nearly every crevice and overhang along the wall during daytime dives — their long antennae protruding from holes are often the first sign. Moray eels share the wall's crevice habitat. Scorpionfish and lionfish are confirmed residents of the rocky outcrops. Reef sharks, including whitetip reef sharks, cruise in the blue water off the wall. Seahorses, frogfish, leaf fish, and pipefish are reported among the coral, making this one of Sipadan's stronger macro sites alongside Coral Gardens. Octopuses are common, particularly at night. Groupers, triggerfish, wrasse, and turtles round out the regular sightings. Manta rays pass through on occasion, though sightings are not routine. The wall itself features hard and soft coral in good condition.

## Dive Profile
A gentle wall drift dive at moderate depth. Descend along the wall to 20-30 metres and drift slowly, peering into the crevices, overhangs, and small caves that characterize this stretch of wall. The irregular wall profile means there are interesting features at all depths, so a multi-level profile works well — start deeper and work gradually shallower. Night dives follow a similar pattern but at shallower depths of 10-18 metres, moving slowly and using torchlight to explore the caves where lobsters and other nocturnal creatures emerge. Safety stop on the reef crest.
