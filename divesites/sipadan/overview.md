...
Sipadan is primarily a wall diving destination. The vertical wall encircles the entire island, starting between 3 and 5 metres from the surface and dropping beyond recreational limits everywhere. Current conditions vary considerably around the island, and sources do not agree neatly by compass direction — the northern tip (Barracuda Point) and southern tip (South Point) consistently experience the strongest currents and require Advanced divers, but several western and southwestern sites (Staghorn Crest, Lobster Lairs) are also reported by multiple sources as current-exposed enough to warrant an Advanced rating, even though their coral-garden tops look calm. Only a few sites (Coral Gardens, White Tip Avenue) are consistently described as suitable for Intermediate divers. The island is also notable for its submarine cave system (Turtle Cavern/Turtle Tomb), which requires full cave diving certification to enter.
