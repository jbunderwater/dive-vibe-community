...
Manado & Bunaken is a premier diving destination in the Asia region, offering 26 documented dive sites with depths ranging from 25 to 25 meters. Manado & Bunaken is particularly known for spectacular wall diving, macro diving, coral biodiversity. Notable sites include Bunaken Wall, Lekuan, Mandolin. Water temperatures average 26-30°C (79-86°F), with visibility typically reaching 10-40 meters (30-130 feet). Year-round diving is possible, with the best conditions during October to April (varies by location).

### Diving Opportunities

- **Shore Diving**: 26 accessible shore dive sites offering convenient, self-guided diving experiences
