...
*Description based on regional Anilao diving characteristics. No site-specific sources found for Rockport Dive Site. Dive site exists in OpenStreetMap but is not documented in available dive operator listings, ScubaBoard, or dive databases. Marine life claims above reflect general Anilao reef conditions, not site-specific observations. Re-checked 2026-08-17: repeated targeted searches (including for "Rockport" specifically, in combination with Anilao/Calumpan/Batangas) still returned no site-specific source. Remains unvalidated; not padded with weak sources. Last updated 2026-08-17.*
