...
*Description based on regional Anilao diving characteristics. No site-specific sources found for Rockport Dive Site. Dive site exists in OpenStreetMap but is not documented in available dive operator listings, ScubaBoard, or dive databases. Re-checked 2026-08-21 (deep QA pass) with a fresh search — still no site-specific source found. Marine life claims above reflect general Anilao reef conditions, not site-specific observations. Last updated 2026-08-21.*
