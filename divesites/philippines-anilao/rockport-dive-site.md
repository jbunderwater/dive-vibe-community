...
*Description based on regional Anilao diving characteristics. No site-specific sources found for Rockport Dive Site meeting this destination's 3-source validation threshold. One possible lead was found this pass: a 2006 ScubaBoard trip report titled "Balayan Bay - beside Anilao" describes diving a "Rockport" wreck — a 40 ft structure on a sandy, sloping bottom in 90-110 feet (27-33m) of water, with tens of thousands of jacks, large maya-maya (giant trevally), and a large grouper. It is uncertain whether this refers to the same location plotted here, and no second or third source could be found to corroborate it, so this remains an unconfirmed lead rather than a basis for reclassifying the site — `validated` stays `false`. Marine life claims above reflect general Anilao reef conditions, not site-specific observations. Last updated 2026-08-19.*
