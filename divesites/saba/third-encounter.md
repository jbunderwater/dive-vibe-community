...
*Note on rarer pelagics: dive-the-world.com — using hedged language like "some lucky divers" and "rare appearance" — reports occasional hammerhead, bull, tiger and whale shark sightings at Third Encounter, plus infrequent actual humpback whale appearances (as opposed to audible song). These come from a single source and should be read as uncommon possibilities, not typical encounters.*
