...
Manta Reef sits outside the Great Astrolabe Reef, Kadavu's vast barrier reef system. Kadavu is Fiji's fourth-largest island and has approximately 90 miles (145 km) of the Great Astrolabe Reef — the world's fourth-largest barrier reef system. Manta Reef is primarily a feeding station for reef manta rays (Mobula alfredi), located approximately 40 minutes by boat from Matava Resort on a submerged reef outside the barrier. Sources confirm mantas are present on roughly 80% of all dives, with the site also serving occasionally as a cleaning station where resident cleaner wrasse service visiting rays. Year-round manta presence is confirmed, with both resident individuals and pelagic visitors. Only a handful of small eco-resorts operate in the Kadavu area, keeping dive pressure low.
...
Reef manta rays (Mobula alfredi) are the signature species. Mantas are present on approximately 80% of all dives according to Matava Resort, which operates dive access to this site. The top of the reef is around 15 meters; the main manta activity zone sits at 15–22 meters. The Matava site description notes a fun swim-through feature also accessible on the dive. The reef supports healthy hard and soft corals, clownfish patches, and schooling fusiliers and surgeonfish. Great hammerhead sharks are noted by Matava Resort as an occasional sighting at the site, along with dogtooth tuna and Pacific sailfish in open water beyond the reef edge. No site-specific count of individuals or verified wing-span data was found in sources consulted.
...
Kadavu is reached from Nadi by a 45-minute flight to Vunisea, or from Suva. Small eco-resorts — Matava Resort (staffed by Mad Fish Dive Centre, a PADI 5-Star operation), Waisalima Beach, and others — operate local dive access. The boat journey to Manta Reef from Matava Resort is approximately 40 minutes. The site is outside the barrier reef, so conditions may be rougher than the sheltered lagoon. Entry by giant stride.
...
---
*Sources: [Matava Resort - Experiences](https://matava.com/experiences), [Dive the World - Kadavu](https://www.dive-the-world.com/diving-sites-fiji-kadavu.php), [Fiji Travel - Diving Great Astrolabe Reef](https://www.fijitravel.org/posts/diving-great-astrolabe-reef/). Last updated 2026-05-26.*
