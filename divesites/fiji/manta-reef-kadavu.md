...
Manta Reef sits approximately 40 minutes by boat from Kadavu's resort areas, outside the Great Astrolabe Reef system — Fiji's fourth-largest island and one of the Pacific's most pristine diving destinations. Papageno Resort, re-checked during the 2026-08-02 re-audit, now explicitly describes the site as a "year-round manta ray cleaning station," accessible to both divers and snorkellers. This corrects the previous version of this page, which framed the site as primarily a feeding area with cleaning as a secondary behavior — that framing is not what the current source says, and has been reversed here: cleaning station behavior is the primary documented characterization, with mantas visiting consistently throughout the year to use the site's cleaning services. The Great Astrolabe Reef provides the broad ecosystem that sustains the manta population. Kadavu is accessed by a 45-minute prop plane flight from Nadi to Vunisea, or by ferry from Suva. Only a handful of small dive resorts operate in the area, keeping pressure low.
...
Reef manta rays (Mobula alfredi) are the signature species, and the site's current documented role is as a cleaning station — mantas visit consistently year-round to be serviced by cleaner wrasse and other cleaner fish at the station coral. Divers may encounter single mantas, small groups, or occasional larger aggregations. Schooling jacks, barracuda, and surgeonfish are reported as regular reef residents. Grey reef sharks patrol the adjacent reef. Papageno Resort accounts mention eagle rays passing through. The surrounding reef structure provides typical Indo-Pacific reef fish diversity. No site-specific reports confirm consistent presence of nurse sharks at this particular site during research.

## Dive Profile

Descend from the boat to the reef structure at 18–22 meters and settle quietly in a loose arc around the cleaning station coral — patience is the core technique for a cleaning-station dive. When mantas arrive to be cleaned, remain stationary and let them set the terms of the encounter. After the manta portion, ascend to the upper reef at 8–12 meters to explore coral gardens during the safety stop.
...
---
*Sources: [Papageno Resort & Dive - Dive Sites](https://www.papagenoresort.com/dive), [Dive The World - Kadavu](https://www.dive-the-world.com/diving-sites-fiji-kadavu.php), [Tourism Fiji - Manta Rays in Fiji](https://www.fiji.travel/things-to-do/wildlife/swimming-with-manta-rays-a-fiji-adventure). Re-audited 2026-08-02: cleaning-station framing corrected against current papagenoresort.com content. Last updated 2026-08-02.*
