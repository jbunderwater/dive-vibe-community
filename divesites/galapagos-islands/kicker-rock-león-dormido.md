...
The most iconic dive in San Cristóbal — twin volcanic tuff pillars split by a 70-foot channel where hammerhead schools, Galapagos sharks, and eagle rays converge in nutrient-rich open ocean.

## Overview

Kicker Rock (León Dormido — "Sleeping Lion") is located approximately 1.5 hours by boat northeast of Puerto Baquerizo Moreno on San Cristóbal Island. The formation is the eroded remnant of a vertical tuff cone that rises approximately 150 meters above the ocean surface and is split by a narrow channel — the primary dive corridor. The two rock faces and the channel between them create a layered underwater environment: a shallow rocky plateau on top, vertical walls descending 20-30 meters in the channel, and open-ocean depths beyond the formation where pelagic species congregate. This is the flagship dive site for San Cristóbal and one of the most celebrated in the entire Galápagos system.

## Overview

The twin rock pillars and the channel between them concentrate pelagic species drawn by nutrient-rich currents sweeping the exposed formation. The walls plunge vertically from the surface to depths of 20-30 meters in the channel, with the outer ocean face dropping significantly further. Multiple sources describe the dive depth for recreational purposes as 15-25 meters average, with the outer walls reaching 30m+. Marine life abundance peaks from May to November when cooler, nutrient-dense water creates more active feeding conditions. Hammerhead sightings are reported year-round, with groups of 20+ documented in the channel.
...
All dives are by guided day trip from Puerto Baquerizo Moreno. Tours include two dives. Divers enter directly from the tour boat; there is no shore access. Currents in the channel can be strong and change direction — guides assess conditions before each entry. SMB deployment is standard for open-water exit. A surface marker buoy is essential given the exposed open-ocean position.
