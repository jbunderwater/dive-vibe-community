...
- Watch your depth carefully as the featureless wall can lead to unintentional deep descents -- set audible depth alerts
- Look along the wall edge where the reef top meets the drop-off for the best shark action
- Peer into wall crevices and overhangs for resting whitetip sharks and macro subjects
- Visit in the morning for the best light on the wall face and most active shark behavior
- A reef hook is useful for pausing at a vantage point when current is running

## Safety Considerations
Strong currents are common and can change direction. The vertical wall creates a real risk of exceeding planned depth, particularly for divers unfamiliar with wall diving. Maintain constant depth awareness and do not chase marine life deeper. Downcurrents are possible along the wall face. This site should only be attempted by divers with wall diving experience and solid buoyancy control. Carry a safety sausage, whistle, and mirror.
