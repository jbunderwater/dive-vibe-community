...
---
*Description based on regional diving characteristics and geographic context. No site-specific verified sources found for the Smith Creek Wreck as a recreational dive site. The OSM entry tags this location as a "dangerous" submerged wreck. Contact NC Underwater Archaeology Branch (https://archaeology.ncdcr.gov) for confirmed site information. Last updated 2026-08-16. QA re-audit 2026-08-16: repeated searches (NC Archaeology, NOAA shipwreck lists, nc-wreckdiving.com, and general web search for "Smith Creek" wreck) again turned up no site-specific source — only one confirmable domain (archaeology.ncdcr.gov, and only as a general reference to historical steamboat traffic on Cape Fear tributaries, not this wreck specifically). This site does not meet the 3-independent-source bar for validation; its `validated` tag is left as previously set per QA policy, but it should be treated as unconfirmed. Corrected a depth inconsistency: the body text previously stated 25 m, which did not match the OSM `depth_max` tag of 20 m — now aligned to 20 m.*
