...
NAD Lembeh's house reef is a well-documented location for the Bobbit worm (Eunice aphroditois) — the enormous ambush predator that buries its segmented body in the sand and strikes prey with spring-loaded jaws — alongside rhinopias, mimic octopus, blue-ringed octopus, wonderpus, flamboyant cuttlefish, hairy frogfish, ghost pipefish, and dragonets, per the resort's own site descriptions. Note that Bobbit worms are also strongly associated with other Lembeh house reefs and muck sites (e.g., Air Prang), so sightings are not exclusive to this location. The site is well-known for coconut octopus, which are observed regularly carrying shells across the sand. Mantis shrimp — both the smasher and spearer varieties — emerge from burrows throughout the slope. Snake eels retreat tail-first into the sand leaving only their heads visible. Hairy frogfish and painted frogfish are documented residents. The sandy areas between rubble patches frequently harbour blue-ringed octopus, flamboyant cuttlefish in season, and various species of nudibranch.
...
---
*Sources: [NAD-Lembeh Resort](https://www.nad-lembeh.com/), [Underwater Photography Guide – Lembeh](https://www.uwphotographyguide.com/lembeh-diving), [Starfish – Lembeh Dive Sites](http://starfish.ch/dive/Lembeh.html). Re-audited 2026-08-10: softened "most reliable Bobbit worm site in the strait" superlative, which could not be independently corroborated, to reflect confirmed species list from the resort's own pages.*
