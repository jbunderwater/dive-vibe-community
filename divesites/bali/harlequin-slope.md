...
---
*Sources: [Michael McFadyen's Scuba Diving Web Site](https://www.michaelmcfadyenscuba.info/viewpage.php?page_id=878). Note: extensive re-search (dive shop sites, ScubaBoard, general web) turned up no second independent source using this site name — most Tulamben operators describe this general muck area near USAT Liberty only informally (e.g. as "Liberty Slope") without the "Harlequin Slope" name or matching level of site-specific detail. Validation_source remains single-source and unresolved. Last updated 2026-07-14.*
