...
---
*Sources: [Michael McFadyen's Scuba Diving Web Site](https://www.michaelmcfadyenscuba.info/viewpage.php?page_id=878). Re-checked 2026-07-15: content re-confirmed against the source (depth ~29m, sand ridges, harlequin shrimp, cuttlefish, blue ribbon eel, cleaner-station moray, nudibranchs, mantis shrimp — all verified). Searched again for corroborating sources (letsdivetulamben.com, worldadventuredivers.com, amedwhitesanddivers.com) but none names a site called "Harlequin Slope" specifically — nearby muck sites are named Batu Niti/Melasti instead. Still only one independent source — validation_source remains single-source and site remains unvalidated pending a second source. Last updated 2026-07-15.*
