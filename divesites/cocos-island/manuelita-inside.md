...
## Entry and Exit
Negative entry from the panga, though conditions here are far calmer than the exposed sites. This is often the gentlest water entry of a Cocos trip. For night dives, entry is the same procedure with torch secured and ready. Exit via ascent to 5 meters for safety stop and panga pickup.
...
---
*Sources: [DAN Alert Diver - Cocos Island](https://dan.org/alert-diver/article/cocos-island/), [DAN Alert Diver - Cocos Island: The Pelagic Crossroads](https://dan.org/alert-diver/article/cocos-island-the-pelagic-crossroads/), [Dive The World - Cocos Island Dive Sites](https://www.dive-the-world.com/diving-sites-cocos.php), [Costa Rica Star News - Tiger Sharks Return to Cocos Island](https://news.co.cr/cocos-island-costa-rica-welcomes-the-return-of-the-tiger-shark/17598/). Re-audited 2026-07-26: depth range (6-22m), the whitetip night-dive frenzy, and the orange frogfish sighting all re-confirmed directly against current DAN source content. The tiger shark "late 2008" date was softened to an approximate 2008-2009 window — sources disagree on the precise year and the Costa Rica Star News article's full text is no longer retrievable to pin it down. ScubaDivingEarth could not be re-fetched this cycle (persistent rate-limiting) and was dropped from the source list pending re-verification. Last updated 2026-07-26.*
